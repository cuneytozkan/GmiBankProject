...
//            String name ="C:\\Users\\sam\\IdeaProjects\\GMIBank\\src\\test\\resources\\test_data\\CustomerInfo.txt";
    ...
    public static void saveRegistrationData(String fileName,Registration registration)  {
        try {
            BufferedWriter writer = new BufferedWriter(new FileWriter(fileName, true));

                writer.append(registration.getPassword()+ "," + registration.getUserName());
                writer.append(registration.getFirstName()+ "," + registration.getLastName());
                writer.append(registration.getSsn()+ "," + registration.getPhoneNumber());
                writer.append(registration.getAddress()+ "," + registration.getEmail()+",\n");
